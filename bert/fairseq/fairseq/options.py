...
from fairseq.utils import (csv_str_list, eval_bool, eval_str_dict,  # noqa
                           eval_str_list)

from bert.fairseq.fairseq.dataclass.configs import (AvgConfig,
                                                    CheckpointConfig,
                                                    CommonConfig,
                                                    CommonEvalConfig,
                                                    DatasetConfig,
                                                    DistributedTrainingConfig,
                                                    EMAConfig, EvalLMConfig,
                                                    GenerationConfig,
                                                    InteractiveConfig,
                                                    OptimizationConfig)
...
def add_avg_args(parser):
    group = parser.add_argument_group("avg")
    gen_parser_from_dataclass(group, AvgConfig())
    return group
