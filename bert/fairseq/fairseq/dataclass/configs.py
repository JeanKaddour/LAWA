...
@dataclass
class AvgConfig(FairseqDataclass):
    avg: bool = field(default=False, metadata={help: "perform checkpoint averaging"})
    avg_start_idx: int = field(
        default=25, metadata={help: "start idx of checkpoint to avg"}
    )
    avg_end_idx: int = field(
        default=35, metadata={help: "end idx of checkpoint to avg"}
    )
    avg_dir: str = field(
